...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //find username and image if exsist
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Toast.makeText(SetupActivity.this, "Firestore Load Error: " , Toast.LENGTH_LONG).show();
                    }
    ...
    private void storeFirestore(Task<Uri> task, final String displayName) {
        ...
        db.collection("USER").document(userId).set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    mainIntent.putExtra("image", downloadUri.toString());
                    startActivity(mainIntent);
                    finish();
                } else {
                    String errorMessage = task.getException().getMessage();
                    Toast.makeText(SetupActivity.this, "Please upload an image and username " + errorMessage, Toast.LENGTH_LONG).show();
                }
                setupProgress.setVisibility(View.INVISIBLE);
            }
        });
